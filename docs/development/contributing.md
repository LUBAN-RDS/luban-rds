...
```bash
# 启动嵌入式服务器
java -cp luban-rds-server/target/luban-rds-server-1.0.3.jar com.janeluo.luban.rds.server.EmbeddedRedisServer

# 启动独立服务器
java -cp luban-rds-bin/target/luban-rds-bin-1.0.3.jar com.janeluo.luban.rds.bin.RedisServerMain
```
